...
func (c *orderServiceClient) GetOrdersBySessionId(ctx context.Context, in *GetOrdersBySessionIdRequest, opts ...grpc.CallOption) (*GetOrdersBySessionIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrdersBySessionIdResponse)
	err := c.cc.Invoke(ctx, OrderService_GetOrdersBySessionId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServiceServer) GetOrdersBySessionId(context.Context, *GetOrdersBySessionIdRequest) (*GetOrdersBySessionIdResponse, error) {
...
func _OrderService_GetOrdersBySessionId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrdersBySessionIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).GetOrdersBySessionId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_GetOrdersBySessionId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrdersBySessionId(ctx, req.(*GetOrdersBySessionIdRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _OrderService_GetOrdersBySessionId_Handler,
		},
		{
